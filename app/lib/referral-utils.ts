...
const POINTS_PER_REFERRAL = process.env.POINTS_PER_REFERRAL; // Points awarded for each successful referral
const TASKS_REQUIRED = process.env.TASKS_REQUIRED; // Number of tasks referred user needs to complete
